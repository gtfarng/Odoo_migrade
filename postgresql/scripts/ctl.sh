...
HOSTNAME=`hostname`
POSTGRESQL_PIDFILE=/opt/bitnami/postgresql/data/postmaster.pid

POSTGRESQL_START="/opt/bitnami/postgresql/bin/pg_ctl start -w -D /opt/bitnami/postgresql/data"
POSTGRESQL_STOP="/opt/bitnami/postgresql/bin/pg_ctl stop -D /opt/bitnami/postgresql/data"
