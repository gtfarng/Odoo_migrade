...
CPPFLAGS=-DAI_ADDRCONFIG=0 -I/opt/bitnami/common/include  -I/bitnami/djangostack-linux-x64/output/sqlite/include -I/opt/bitnami/common/include/sasl -I/opt/bitnami/common/include
LDFLAGS=-L/opt/bitnami/python/lib -L/bitnami/djangostack-linux-x64/output/sqlite/lib -L/opt/bitnami/common/lib -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
